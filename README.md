...
- Committed lightweight summaries: `profiling/vllm_cpu_overhead/results/`

Large raw profiler captures are excluded from Git. Regenerate them with the commands in the report when needed.
